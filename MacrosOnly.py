...
def main():
    ...
    while user != '0':
        ...
        if user == '1': #---------------------------------------------------list products----------------------------------------------
            ...
            for profile in range(len(nutritionProfiles)): print (nutritionProfiles[profile])
            ...
            bestDiet, bestNutrients, positions = generateDiet.guessOptimal(1000000, productDataPure, nutritionProfilePure, True, 10) #first paremeter is amount of guesses, 50000 usually gives near best results but the more the better
            ...
            for nutrient in range(len(nutritionProfiles[0])-1):
                ...
                print (nutritionProfiles[0][nutrient+1] + ': ' + str(bestNutrients[nutrient]))
